    ...
    <>
      ...
      <div className="app__profiles">
        <p className="p-text para">
          ...
          for NASA's exploratory missions to new worlds. (NASA if you are seeing
          this, my offer is still very much open). This eagerness to embrace the
          unknown mirrors my proactive approach to professional growth. Whether
          contributing within a team or working independently, I am dedicated to
